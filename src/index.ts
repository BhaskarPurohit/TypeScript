...
//     constructor(private height:number, weight:number, protected power:number){
...
// const bhaskar = new newPlayer(100,25,22, false)
// console.log(bhaskar.getPower())
...
const bhaskar = new Player(100,10,23)
